...
export default function HouseCatalog() {
  return (
    <>
      <section className="bg-[#0B3A2C] rounded-bl-4xl rounded-br-4xl px-5 py-2 mb-4">
        <Header burger_color="white" />

        <h1 className="text-3xl text-[#F9F9F9] font-bold mb-4">
      ...
      <section className="mb-4 bg-[#09261D] rounded-4xl  px-5 py-4 ">
        <form className="flex-col-center gap-3" action="">
          <div
            className="bg-[#F9F9F9] rounded-4xl py-2 px-4 w-75 flex-row-between gap-2 border border-transparent
    ...
    transition"
          >
            <input
              className=" placeholder:text-lg placeholder:text-[#b4b4b4]   outline-none"
          ...
          <select
            className="bg-[#F9F9F9] rounded-4xl py-2 px-4 w-75"
            name=""
            id=""
          >
        ...
        <ul className="flex-col-center gap-4">
          <li className="flex flex-col gap-1">
            ...
            <p className="text-sm text-[#09261D] font-[family-name:var(--font-poppins)]">
              An intimate retreat crafted for two. A luxurious king-size bed, a
              private outdoor bath for stargazing, and a cozy interior where
          ...
          <li className="flex flex-col gap-1">
            ...
            <p className="text-sm text-[#09261D] font-[family-name:var(--font-poppins)]">
              ...
              Ideal for gatherings with friends or family vacations where no one
              feels cramped.
            </p>
          </li>
          <li className="flex flex-col gap-1">
            ...
            <p className="text-sm text-[#09261D] font-[family-name:var(--font-poppins)]">
              Minimalism and thoughtful design. Panoramic glazing, clean lines,
              and intelligent lighting create an atmosphere of harmony with
          ...
          <li className="flex flex-col gap-1">
            ...
            <p className="text-sm text-[#09261D] font-[family-name:var(--font-poppins)]">
              A safe and thoughtful space for making memories. Separate bedrooms
              for parents and children, a durable yet stylish interior, and a
              layout that brings everyone together for shared meals and games.
            </p>
          </li>
        </ul>
      </section>
